...
export const TITLES: TitleDefinition[] = [
  ...
  // =========================================
  {
    id: 't-lv2', name: '旅支度', icon: '🎒',
    description: '冒険の準備を整えた者', condition: 'Lv2到達',
  ...
  {
    id: 't-lv8', name: '森の探索者', icon: '🌿',
    description: '初めての探索を終えた見習い', condition: 'Lv8到達',
    check: (ctx) => ctx.level >= 8,
  },
  {
    id: 't-lv10', name: '駆け出しの冒険者', icon: '🗡️',
    description: '冒険の基礎を身につけた者', condition: 'Lv10到達',
    check: (ctx) => ctx.level >= 10,
  },
  {
    id: 't-lv12', name: '道標の読み手', icon: '🧭',
    description: '旅の道しるべを読み解く者', condition: 'Lv12到達',
    check: (ctx) => ctx.level >= 12,
  },
  {
    id: 't-lv17', name: '洞窟の踏破者', icon: '🕯️',
    description: '暗闇に怯まず進む冒険者', condition: 'Lv17到達',
    check: (ctx) => ctx.level >= 17,
  },
  {
    id: 't-lv20', name: '熟練の冒険者', icon: '⚔️',
    description: '確かな腕を持つ冒険者', condition: 'Lv20到達',
    check: (ctx) => ctx.level >= 20,
  },
  {
    id: 't-lv22', name: '盾の守護者', icon: '🛡️',
    description: '仲間を守る盾となる者', condition: 'Lv22到達',
    check: (ctx) => ctx.level >= 22,
  },
  {
    id: 't-lv25', name: '四分の一の旅路', icon: '🗺️',
    description: '長き旅の四分の一を歩んだ', condition: 'Lv25到達',
    check: (ctx) => ctx.level >= 25,
  },
  {
    id: 't-lv28', name: '竜の足跡', icon: '🐉',
    description: '竜の痕跡を追う冒険者', condition: 'Lv28到達',
  ...
  {
    id: 't-lv32', name: '秘宝の探索者', icon: '🔍',
    description: '隠された宝を見つけ出す眼', condition: 'Lv32到達',
    check: (ctx) => ctx.level >= 32,
  },
  {
    id: 't-lv35', name: '嵐を越えし者', icon: '⚡',
    description: '数多の嵐を乗り越えた強者', condition: 'Lv35到達',
    check: (ctx) => ctx.level >= 35,
  },
  {
    id: 't-lv38', name: '砦の守り手', icon: '🏰',
    description: '仲間から頼られる存在', condition: 'Lv38到達',
    check: (ctx) => ctx.level >= 38,
  },
  {
    id: 't-lv42', name: '魔法の使い手', icon: '💎',
    description: '神秘の力を操る冒険者', condition: 'Lv42到達',
    check: (ctx) => ctx.level >= 42,
  },
  {
    id: 't-lv45', name: '英雄の刻印', icon: '📜',
    description: '歴史に名を刻む者', condition: 'Lv45到達',
    check: (ctx) => ctx.level >= 45,
  },
  {
    id: 't-lv48', name: '賢者の知恵', icon: '🧙',
    description: '深い知恵を持つ助言者', condition: 'Lv48到達',
    check: (ctx) => ctx.level >= 48,
  },
  {
    id: 't-lv50', name: '伝説の冒険者', icon: '👑',
    description: '伝説に名を刻む冒険の達人', condition: 'Lv50到達',
    check: (ctx) => ctx.level >= 50,
  },
  {
    id: 't-lv52', name: '伝説の継承者', icon: '📖',
    description: '先人の志を受け継ぐ者', condition: 'Lv52到達',
    check: (ctx) => ctx.level >= 52,
  },
  {
    id: 't-lv55', name: '星の探求者', icon: '⭐',
    description: '星の導きに従う探求者', condition: 'Lv55到達',
    check: (ctx) => ctx.level >= 55,
  },
  {
    id: 't-lv58', name: '深淵の渡り手', icon: '🌊',
    description: '言葉を超えた境地の旅人', condition: 'Lv58到達',
  ...
  {
    id: 't-lv63', name: '剣聖の魂', icon: '⚔️',
    description: '剣に魂を宿す達人', condition: 'Lv63到達',
    check: (ctx) => ctx.level >= 63,
  },
  {
    id: 't-lv65', name: '極限の探究者', icon: '🗻',
    description: '極限へと到達する者', condition: 'Lv65到達',
    check: (ctx) => ctx.level >= 65,
  },
  {
    id: 't-lv68', name: '竜殺しの勇者', icon: '🐲',
    description: '竜をも倒す力を持つ者', condition: 'Lv68到達',
    check: (ctx) => ctx.level >= 68,
  },
  {
    id: 't-lv70', name: '英雄の証', icon: '🎖️',
    description: '世に知られる英雄', condition: 'Lv70到達',
    check: (ctx) => ctx.level >= 70,
  },
  {
    id: 't-lv73', name: '旅の哲人', icon: '📿',
    description: '旅を通じ真理に至る者', condition: 'Lv73到達',
    check: (ctx) => ctx.level >= 73,
  },
  {
    id: 't-lv75', name: '高みの到達者', icon: '🦅',
    description: '高みへと昇りゆく者', condition: 'Lv75到達',
    check: (ctx) => ctx.level >= 75,
  },
  {
    id: 't-lv78', name: '天空の守護者', icon: '🛡️',
    description: '天空の加護を受けし者', condition: 'Lv78到達',
  ...
  {
    id: 't-lv83', name: '神域の使者', icon: '🌟',
    description: '神々の使命を受けし者', condition: 'Lv83到達',
    check: (ctx) => ctx.level >= 83,
  },
  {
    id: 't-lv85', name: '頂への挑戦者', icon: '⛰️',
    description: '頂に手が届く者', condition: 'Lv85到達',
    check: (ctx) => ctx.level >= 85,
  },
  {
    id: 't-lv88', name: '一撃必殺', icon: '💥',
    description: '一撃に全てを込める達人', condition: 'Lv88到達',
    check: (ctx) => ctx.level >= 88,
  },
  {
    id: 't-lv90', name: '仙人の境地', icon: '🧓',
    description: '人の域を超えた冒険者', condition: 'Lv90到達',
    check: (ctx) => ctx.level >= 90,
  },
  {
    id: 't-lv93', name: '星渡りの旅人', icon: '🌠',
    description: '星をも渡る冒険者', condition: 'Lv93到達',
    check: (ctx) => ctx.level >= 93,
  },
  {
    id: 't-lv95', name: '頂点の旅人', icon: '🏔️',
    description: '頂点を目前にした者', condition: 'Lv95到達',
    check: (ctx) => ctx.level >= 95,
  },
  {
    id: 't-lv98', name: '世界を巡る者', icon: '🌍',
    description: '天と地を巡る冒険者', condition: 'Lv98到達',
    check: (ctx) => ctx.level >= 98,
  },
  {
    id: 't-lv100', name: '伝説の英雄', icon: '👑',
    description: 'すべてを極めし伝説の英雄', condition: 'Lv100到達',
  ...
  },
  {
    ...
    description: '7日間の冒険を達成した者', condition: '7日間記録',
  ...
  // ===== 連続達成系 =====
  {
    id: 't-streak7', name: '七日の継続', icon: '🔥',
    description: '七日間途切れぬ道を歩んだ者', condition: '7日連続記録',
  ...
  // ===== 復帰系 =====
  {
    ...
    description: '再び冒険の道に戻った不屈の冒険者', condition: '復帰チャレンジ達成',
