...
export default function StatCard({ label, emoji, level, currentXP, nextXP, completions, color }: StatCardProps) {
  return (
    <div className="rpg-panel p-4">
      ...
      <div className={`text-3xl font-bold pixel-num stat-value ${color}`}>Lv.{level}</div>
